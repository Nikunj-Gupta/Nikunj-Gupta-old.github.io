...
<div style="width:120%;height:425px;overflow:auto;">
...
<div class="pricing-box-container">
	...
	<div class="pricing-box text-center">
        ...
        <p><small> Summer School, IIITB<br> 
        Prof. Prashanth LA (IIT-Madras)<br>
        Summer 2019</small> </p>
	</div>

	<div class="pricing-box text-center">
		<h3>Teaching Assistant</h3> 
		<p> Corporate Training course on Machine Learning</p>
        <p><small> Videoken, Bangalore<br> 
        Prof. A. Rajkumar (IIT-Madras)<br>
        Prof. Ramamurthy <br> 
        Spring 2019</small> </p>
	</div>
	...
	<div class="pricing-box text-center">
        ...
        <p><small> Academic Course, IIITB<br> 
        Prof. Amit Chattopadhyay (IIITB) <br>
        Prof. V Ramasubramanian (IIITB) <br>
        Fall 2018 </small> </p>
	</div>
...
<div class="pricing-box-container">
	...
	<div class="pricing-box text-center">
		<h3>Mentor</h3> 
		<p> Student Mentoring Program </p>
        <p><small> IIIT Bangalore<br> 
        Mentored five freshman year students and helped them transition to college life.<br>
        2017-2018</small> </p>
	</div>

	<div class="pricing-box text-center">
		<h3>SPOC</h3> 
		<p> Badminton and Tug of War</p>
        <p><small> 
        Spandan (Sports fest) at IIIT-B<br> 
        Managed and organised sports matches during the fest.<br> 
        March'18 and March'16
        </small> </p>
	</div>

	<div class="pricing-box text-center">
		<h3>Food Committee</h3> 
		<p> A Student-Driven Body responsible for taking college mess related decisions </p>
        <p><small> IIIT Bangalore<br> 
        Represented 1200+ people<br>
        2015-2016 </small> </p>
	</div>
